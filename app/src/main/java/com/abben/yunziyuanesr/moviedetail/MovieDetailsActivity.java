...
public class MovieDetailsActivity extends AppCompatActivity implements MovieDetailsView,View.OnClickListener{
    ...
    public void showMovieDetails(Movie movie) {
        ...
        TextView summary_of_movie = (TextView) findViewById(R.id.summary_of_movie);
        summary_of_movie.setText(movie.getSummaryOfMovie());
        TextView yun_password = (TextView) findViewById(R.id.yun_password);
        yun_password.setText(movie.getYunPassword());

        FloatingActionButton link_baidupan = (FloatingActionButton) findViewById(R.id.link_baidupan);
