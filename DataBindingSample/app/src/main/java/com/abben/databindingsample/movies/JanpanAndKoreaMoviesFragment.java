...
public class JanpanAndKoreaMoviesFragment extends Fragment implements BaseView, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onRefresh() {
        RetrofitHelper.getRetrofit().create(MoviesApi.class).fetchMovies("JanpanAndKoreaMovies")
